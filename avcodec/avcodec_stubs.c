...
static struct custom_operations codec_parameters_ops = {
    "ocaml_avcodec_parameters", custom_finalize_default,
...
static struct custom_operations packet_ops = {
    "ocaml_packet",      custom_finalize_default,  custom_compare_default,
...
static struct custom_operations parser_ops = {
    "ocaml_avcodec_parser",   custom_finalize_default,
    custom_compare_default,   custom_hash_default,
    custom_serialize_default, custom_deserialize_default};
...
static struct custom_operations codec_context_ops = {
    "ocaml_codec_context",    custom_finalize_default,
    custom_compare_default,   custom_hash_default,
    custom_serialize_default, custom_deserialize_default};
