...
let () =
  let fillers = [Set.fill_image; Planar_set.fill_image;
                 Bigarray_copy.fill_image; Bytes_copy.fill_image;
                 Bigarray_scale.fill_image; Bytes_scale.fill_image;
                 Wrap.fill_image] in

  let getters = [Set.get_image; Planar_set.get_image;
                 Bigarray_copy.get_image; Bytes_copy.get_image;
                 Wrap.get_image] in
