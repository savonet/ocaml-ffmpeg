...
module type AudioData = sig
  type t val vk : vector_kind val sf : Avutil.Sample_format.t option
end
...
module Bytes : sig
  type t = bytes val vk : vector_kind val sf : 'a option
end

(** Unsigned 8 bit sample format byte string for interleaved channels. *)
module U8Bytes : sig
  type t = bytes val vk : vector_kind val sf : SF.t option
end
...
module U8PlanarBytes : sig
  type t = bytes array val vk : vector_kind val sf : SF.t option
end
