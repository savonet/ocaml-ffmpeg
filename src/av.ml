...
(*
external create_resample : ?channel_layout:channel_layout -> ?sample_format:sample_format -> ?sample_rate:int -> t -> Swresample.t = "ocaml_av_create_resample"
*)
...
external video_to_string : video_frame -> string = "ocaml_av_video_to_string"
